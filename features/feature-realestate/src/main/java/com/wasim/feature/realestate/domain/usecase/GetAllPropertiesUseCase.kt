...
internal class GetAllPropertiesUseCase @Inject constructor(
    private val repository: PropertyRepository,
    private val dispatcherProvider: BaseDispatcherProvider,
) {
    operator fun invoke(): Flow<Output<List<Property>>> =
        repository.getProperties().map { properties ->
    ...
    private fun getOutput(properties: List<Property>): Output<List<Property>> = Output.Success(properties)
}
